...
<x-modal :name="$name" maxWidth="md">
    <div class="p-6 text-center whitespace-normal break-words w-full" dir="rtl">
        <!-- Centered Icon -->
        ...
        <h3 class="text-base sm:text-lg font-black text-slate-800 mb-2 text-center whitespace-normal break-words leading-relaxed">{{ $title }}</h3>
        <p class="text-xs sm:text-sm text-slate-500 leading-relaxed mb-6 text-center whitespace-normal break-words px-2">{{ $message }}</p>
