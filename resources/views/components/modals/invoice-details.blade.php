...
<div x-show="showDetailsModal" x-cloak class="fixed inset-0 z-[60] overflow-y-auto">
    <div class="flex items-start justify-center min-h-screen pt-10 sm:pt-16 p-4 text-center" @click.self="showDetailsModal = false">
        ...
        <div x-show="showDetailsModal" @click.outside="showDetailsModal = false" x-transition class="relative w-full max-w-5xl p-5 sm:p-6 text-right transition-all transform bg-white shadow-2xl rounded-2xl z-10">
