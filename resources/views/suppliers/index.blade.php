        ...
        <div class="bg-white rounded-xl p-3 sm:p-4 border border-slate-100 shadow-sm mb-4">
            ...
            <div x-show="showFilters" 
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-2.5">
                    ...
                    <!-- Min Balance -->
                    <div>
                        <label class="block text-[0.72rem] font-bold text-slate-600 mb-1">من رصيد (مستحق)</label>
                    ...
                    <!-- Max Balance -->
                    <div>
                        <label class="block text-[0.72rem] font-bold text-slate-600 mb-1">إلى رصيد (مستحق)</label>
