            ...
            <div x-show="showFilters" 
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-2.5">
                    ...
                    <div class="flex flex-col">
                        ...
                        <select x-model="customer_id" @change="fetchData()" class="w-full h-9 px-2.5 py-1.5 bg-slate-50 border border-slate-200 rounded-lg text-xs font-semibold text-slate-700 focus:bg-white focus:outline-none focus:border-primary-500 box-border">
        ...
        <div x-show="showExportModal" 
            ...
            <div x-show="showExportModal" 
                ...
                <div class="flex items-center gap-3.5 mb-4 pb-3 border-b border-slate-100">
                    ...
                    <div>
                        <h3 class="text-base font-black text-slate-800">تصدير تقرير المبيعات (PDF)</h3>
                ...
                <div class="bg-slate-50 rounded-xl p-3.5 border border-slate-200/80 mb-5 space-y-2.5 text-xs">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="font-bold text-slate-800">تقرير فواتير ومبيعات العملاء</span>
                    </div>
                    <div class="flex items-center justify-between">
