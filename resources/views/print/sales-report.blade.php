                        ...
                        <table class="print-data-table">
                            ...
                            <tbody>
                                @forelse($sales as $index => $sale)
                                    ...
                                    <tr>
                                        <td>{{ $index + 1 }}</td>
                                        <td style="font-weight: 800; font-family: monospace; direction: ltr;">INV-{{ str_pad($sale->id, 6, '0', STR_PAD_LEFT) }}</td>
                                        <td style="font-family: monospace; direction: ltr;">{{ $sale->created_at->format('Y-m-d') }}</td>
                                        ...
                                        <td style="direction: ltr; font-family: monospace; font-weight: 800;">{{ format_amount($sale->total_amount) }} ج.م</td>
                                        <td style="direction: ltr; font-family: monospace; color: #166534;">{{ format_amount($sale->paid_amount) }} ج.م</td>
                                        <td style="direction: ltr; font-family: monospace; font-weight: 800;" class="{{ $sale->remaining_amount > 0 ? 'danger' : 'success' }}">
