            ...
            <div x-show="showFilters" 
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3">
                    ...
                    <div>
                        ...
                        <select x-model="supplier_id" @change="fetchData()" class="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg text-xs font-bold text-slate-700 focus:bg-white focus:outline-none focus:border-primary-500">
                    ...
                    <!-- Product Filter -->
                    <div>
                        <label class="block text-xs font-bold text-slate-600 mb-1.5">الصنف المشترى</label>
