            ...
            <div x-show="showFilters" 
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-2.5">
                    ...
                    <div class="flex flex-col">
                        ...
                        <select x-model="supplier_id" @change="fetchData()" class="w-full h-8.5 px-2.5 py-1.5 bg-slate-50 border border-slate-200 rounded-lg text-xs font-semibold text-slate-700 focus:bg-white focus:outline-none focus:border-primary-500">
